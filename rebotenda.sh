curl -c cookie-tenda.txt 'http://192.168.1.253/login/Auth' \
  -H 'Connection: keep-alive' \
  -H 'Cache-Control: max-age=0' \
  -H 'Upgrade-Insecure-Requests: 1' \
  -H 'Origin: http://192.168.1.253' \
  ...
  -H 'Sec-GPC: 1' \
  -H 'Referer: http://192.168.1.253/login.html' \
  -H 'Accept-Language: en-US,en;q=0.9' \
  -H 'Cookie: bLanguage=en; ecos_pw=c3lhZmlrMDAxazx:language=cn' \
  --data-raw 'password=c3lhZmlrMDAx' \
  --insecure

curl -b cookie-tenda.txt 'http://192.168.1.253/goform/sysReboot' \
  -H 'Connection: keep-alive' \
  -H 'User-Agent: Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.105 Mobile Safari/537.36' \
  -H 'Content-Type: application/x-www-form-urlencoded;' \
  -H 'Accept: */*' \
  -H 'Sec-GPC: 1' \
  -H 'Origin: http://192.168.1.253' \
  -H 'Referer: http://192.168.1.253/index.html' \
  -H 'Accept-Language: en-US,en;q=0.9' \
